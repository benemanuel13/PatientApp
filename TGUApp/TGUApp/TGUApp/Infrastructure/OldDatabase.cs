...
namespace TGUWeb.Infrastructure
{
    public static class Database
    {
        ...
        {
            CrisisPlan plan = new CrisisPlan(1);

            plan.Sections.Add(new CrisisPlanSection(1, 1, "If I start to feel unsafe or unwell I may... (What may happen if you go into crisis, does your sleep pattern change? Does your mood change?  What has happened in the past?", "My sleep is bad.\r\nI get angry all the time.\r\nI stop cleaning myself."));
            plan.Sections.Add(new CrisisPlanSection(2, 1, "Things I need to do to keep myself safe and well...", "Keep taking my medication.\r\nExercise regularly.\r\nKeep appointments."));
            plan.Sections.Add(new CrisisPlanSection(3, 1, "Things others need to do to keep me safe and well...", "Watch for my relapse indicators.\r\nTurn up to appointments."));
